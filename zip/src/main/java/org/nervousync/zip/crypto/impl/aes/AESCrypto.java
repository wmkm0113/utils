...
public class AESCrypto {
	 ...
	 */
	CryptoAdaptor macBasedPRF = null;
//	private final boolean forEncryption;
	...
	private byte[] deriveKey(final byte[] saltBytes, final char[] password, final int dkLen)
		...
		CryptoAdaptor digestProvider = SecurityUtils.HmacSHA1(passwordBytes);
	...
	private static void process(final CryptoAdaptor baseDigestProvider,
