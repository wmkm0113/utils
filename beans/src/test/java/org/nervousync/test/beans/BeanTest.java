...
public final class BeanTest extends BaseTest {
    ...
    public void copyTest() {
		...
		String string = BeanUtils.objectToString(genericBean, StringType.JSON);
        this.logger.info("Bean_Copy_Result", "generic", string);
		GenericBean parsedObject = BeanUtils.stringToObject(string, StringType.JSON, GenericBean.class);
        if (parsedObject != null) {
            WrapperBean wrapperBean = new WrapperBean();
            BeanUtils.copyData(parsedObject, wrapperBean);
            this.logger.info("Bean_Copy_Result",
                    "wrapper", BeanUtils.objectToString(wrapperBean, StringType.JSON));
        }
    }
    ...
    public void beanCopyToTest() {
        ...
        this.logger.info("Bean_Copy_Result", "bean two", BeanUtils.objectToString(beanTwo, StringType.JSON));
        this.logger.info("Bean_Copy_Result", "bean three", BeanUtils.objectToString(beanThree, StringType.JSON));
        this.logger.info("Bean_Copy_Result", "bean four", BeanUtils.objectToString(beanFour, StringType.JSON));
        this.logger.info("Bean_Copy_Result", "bean five", BeanUtils.objectToString(beanFive, StringType.JSON));
    }
    ...
    public void beanCopyFromTest() {
        ...
        this.logger.info("Bean_Copy_Result", "bean one", BeanUtils.objectToString(beanOne, StringType.JSON));
    ...
    public void beanCopyDataTest() {
        ...
        this.logger.info("Bean_Copy_Result",
                InnerBean.class.getSimpleName(), BeanUtils.objectToString(innerBean, StringType.JSON));
    }
    ...
    private WrapperBean generateWrapper() {
        ...
        this.logger.info("Bean_Generate_Result",
                WrapperBean.class.getSimpleName(), BeanUtils.objectToString(origBean, StringType.JSON));
        return origBean;
    }
    ...
    private BeanOne generateBeanOne() {
        ...
        this.logger.info("Bean_Generate_Result",
                BeanOne.class.getSimpleName(), BeanUtils.objectToString(beanOne, StringType.JSON));
        return beanOne;
    }
    ...
    private DataBean generateDataBean() {
        ...
        this.logger.info("Bean_Generate_Result",
                DataBean.class.getSimpleName(), BeanUtils.objectToString(dataBean, StringType.JSON));
        return dataBean;
    }
    ...
    private BeanTwo generateBeanTwo() {
        ...
        this.logger.info("Bean_Generate_Result",
                BeanTwo.class.getSimpleName(), BeanUtils.objectToString(beanTwo, StringType.JSON));
        return beanTwo;
    }
    ...
    private BeanThree generateBeanThree() {
        ...
        this.logger.info("Bean_Generate_Result",
                BeanThree.class.getSimpleName(), BeanUtils.objectToString(beanThree, StringType.JSON));
        return beanThree;
    }
    ...
    private BeanFour generateBeanFour() {
        ...
        this.logger.info("Bean_Generate_Result",
                BeanFour.class.getSimpleName(), BeanUtils.objectToString(beanFour, StringType.JSON));
        return beanFour;
    }
    ...
    private BeanFive generateBeanFive() {
        ...
        this.logger.info("Bean_Generate_Result",
                BeanFive.class.getSimpleName(), BeanUtils.objectToString(beanFive, StringType.JSON));
        return beanFive;
    }
