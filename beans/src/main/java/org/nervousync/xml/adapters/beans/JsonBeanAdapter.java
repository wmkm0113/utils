 ...
 */
public final class JsonBeanAdapter extends TransferBeanAdapter {

	/**
	 * <h3 class="en-US">Constructor method for JavaBean JSON convert adapter</h3>
	 * <h3 class="zh-CN">JavaBean数据JSON转换适配器的构造方法</h3>
	 *
	 ...
	 */
	public JsonBeanAdapter(final String className) throws IllegalArgumentException {
		super(className, StringType.JSON);
	}
}
