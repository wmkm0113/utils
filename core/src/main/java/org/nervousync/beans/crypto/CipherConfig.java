...
public final class CipherConfig implements Serializable {
	 ...
	 *                  <span class="zh-CN">密码算法</span>
	 */
	public CipherConfig(@Nonnull final String algorithm) {
		this(algorithm, Globals.DEFAULT_VALUE_STRING, Globals.DEFAULT_VALUE_STRING);
	}
	 ...
	 *                  <span class="zh-CN">数据填充模式</span>
	 */
	public CipherConfig(@Nonnull final String algorithm, @Nonnull final String mode, @Nonnull final String padding) {
	...
	public boolean isAsymmetric() {
		return this.algorithm.contains("RSA") || this.algorithm.contains("SM2");
	}
