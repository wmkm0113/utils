...
/**
 * <h2 class="en-US">Interface class of encrypt/decrypt data provider</h2>
 * <h2 class="zh-CN">加密解密数据适配器的接口</h2>
 *
...
public abstract class CryptoAdaptor {
	...
	/**
	 * <h3 class="en-US">Append given string to current adapter and calculate the final result</h3>
