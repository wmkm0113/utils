...
public final class DigestTest extends BaseTest {
    ...
    public void SHAKE128() throws CryptoException {
        ...
        this.logger.info("Digits_Result", "SHAKE128", ConvertUtils.bytesToHex(secureAdapter.finish("123456")), "(Provider)");
    ...
    public void SHAKE256() throws CryptoException {
        ...
        this.logger.info("Digits_Result", "SHAKE256", ConvertUtils.bytesToHex(secureAdapter.finish("123456")), "(Provider)");
    ...
    public void SM3() throws CryptoException {
        ...
        this.logger.info("Digits_Result", "SM3", ConvertUtils.bytesToHex(secureAdapter.finish("123456")), "(Provider)");
