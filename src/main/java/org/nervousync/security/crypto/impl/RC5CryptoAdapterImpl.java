...
public final class RC5CryptoAdapterImpl extends SymmetricCryptoAdapter {
	 ...
	 */
	public RC5CryptoAdapterImpl(final CipherConfig cipherConfig, final CryptoMode cryptoMode, final byte[] keyBytes)
	...
	protected Cipher initCipher() throws CryptoException {
		return super.generateCipher(new SecretKeySpec(this.cipherKey.getKeyBytes(), "RC5"),
